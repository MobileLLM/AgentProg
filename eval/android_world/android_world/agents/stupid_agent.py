...
class StupidAgent(base_agent.EnvironmentInteractingAgent):
  """Stupid agent; wait for user to indicate they are done."""

  def step(self, goal: str) -> base_agent.AgentInteractionResult:
    Path("/tmp/task_description.txt").write_text(goal)
    sys.exit()
    del goal
    response = input(
