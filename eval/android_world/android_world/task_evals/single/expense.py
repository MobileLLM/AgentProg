...
class ExpenseDeleteMultipleLong(_ExpenseDeleteMultiple):
  """Task to delete multiple expenses in an expense tracking app."""
...
class ExpenseDeleteMultipleSuperLong(_ExpenseDeleteMultiple):
  """Task to delete multiple expenses in an expense tracking app."""
...
class ExpenseDeleteMultipleLong2(_ExpenseDeleteMultiple):
  """Harder task to delete multiple expenses in an expense tracking app."""
...
class ExpenseDeleteMultipleSuperLong2(_ExpenseDeleteMultiple):
  """Harder task to delete multiple expenses in an expense tracking app."""
...
# 暂时过不了 _validate_initial_state.
# class ExpenseDeleteDuplicatesLong(_ExpenseDeleteDuplicates):
#   """Deduplicate expenses in the expense tracking app with some noise."""
  # complexity = 100
#   n_rows = 3
#   n_rows_noise = 10

# class ExpenseDeleteDuplicatesSuperLong(_ExpenseDeleteDuplicates):
#   """Deduplicate expenses in the expense tracking app with some noise."""
  # complexity = 100
#   n_rows = 10
#   n_rows_noise = 50
...
class ExpenseAddMultipleLong(_ExpenseAddMultiple):
  """Task to add multiple expenses in the Expense Tracking App."""
...
class ExpenseAddMultipleSuperLong(_ExpenseAddMultiple):
  """Task to add multiple expenses in the Expense Tracking App."""
