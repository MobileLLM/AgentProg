...
class RecipeDeleteMultipleRecipesLong(_RecipeDeleteMultipleRecipes):
  """Delete multiple recipes in Broccoli Recipe App."""
...
class RecipeDeleteMultipleRecipesSuperLong(_RecipeDeleteMultipleRecipes):
  """Delete multiple recipes in Broccoli Recipe App."""
...
class RecipeDeleteMultipleRecipesWithNoiseLong(_RecipeDeleteMultipleRecipes):
  """Delete multiple recipes in Broccoli Recipe App with noise."""
...
class RecipeDeleteMultipleRecipesWithNoiseSuperLong(_RecipeDeleteMultipleRecipes):
  """Delete multiple recipes in Broccoli Recipe App with noise."""
...
class RecipeDeleteMultipleRecipesWithConstraintLong(RecipeDeleteMultipleRecipesWithConstraint):
  complexity = 100
  n_rows = 10
  n_rows_noise = 29

class RecipeDeleteMultipleRecipesWithConstraintSuperLong(RecipeDeleteMultipleRecipesWithConstraint):
  complexity = 100
  n_rows = 20
  n_rows_noise = 29
...
class RecipeAddMultipleRecipesLong(_RecipeAddMultipleRecipes):
  """Task to delete multiple recipes in Broccoli Recipe App."""
...
class RecipeAddMultipleRecipesSuperLong(_RecipeAddMultipleRecipes):
  """Task to delete multiple recipes in Broccoli Recipe App."""
