...
class SimpleCalendarDeleteEventsLong(SimpleCalendarDeleteEvents):
  n_rows = 10
  n_rows_noise = 20
  complexity = 100
  template = (
...
class SimpleCalendarDeleteEventsSuperLong(SimpleCalendarDeleteEvents):
  n_rows = 20
  n_rows_noise = 50
  complexity = 100
  template = (
...
class SimpleCalendarDeleteEventsOnRelativeDayLong(SimpleCalendarDeleteEventsOnRelativeDay):
...
class SimpleCalendarDeleteEventsOnRelativeDaySuperLong(SimpleCalendarDeleteEventsOnRelativeDay):
