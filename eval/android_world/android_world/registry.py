...
from android_world.task_evals.composite import markor_and_many, markor_sms
from android_world.task_evals.composite import contacts_sms
...
class TaskRegistry:
  ...
  _TASKS = (
      ...
      calendar.SimpleCalendarDeleteEventsLong,
      calendar.SimpleCalendarDeleteEventsOnRelativeDay,
      calendar.SimpleCalendarDeleteEventsOnRelativeDayLong,
      calendar.SimpleCalendarDeleteEventsOnRelativeDaySuperLong,
      calendar.SimpleCalendarDeleteEventsSuperLong,
      ...
      contacts_sms.ContactsAddContactAndSms,
      contacts_sms.ContactsAddMultipleContactsAndSms,
      ...
      expense.ExpenseAddMultipleLong,
      expense.ExpenseAddMultipleSuperLong,
      expense.ExpenseAddSingle,
      expense.ExpenseDeleteDuplicates,
      # # expense.ExpenseDeleteDuplicatesLong,
      # # expense.ExpenseDeleteDuplicatesSuperLong,
      expense.ExpenseDeleteDuplicates2,
      expense.ExpenseDeleteMultiple,
      # expense.ExpenseDeleteMultipleLong,
      expense.ExpenseDeleteMultipleLong2,
      expense.ExpenseDeleteMultipleSuperLong,
      expense.ExpenseDeleteMultipleSuperLong2,
      ...
      markor.MarkorMergeNotesLong,
      # markor.MarkorMergeNotesSuperLong,
      ...
      markor_sms.MarkorFetchMultipleNotesAndSms,
      markor_sms.MarkorFetchNoteAndSms,
      markor_and_many.MarkorTodoList,
      # OsmAnd.
      ...
      recipe.RecipeAddMultipleRecipesLong,
      recipe.RecipeAddMultipleRecipesSuperLong,
      ...
      recipe.RecipeDeleteMultipleRecipesLong,
      recipe.RecipeDeleteMultipleRecipesSuperLong,
      recipe.RecipeDeleteMultipleRecipesWithConstraint,
      # recipe.RecipeDeleteMultipleRecipesWithConstraintLong,
      # recipe.RecipeDeleteMultipleRecipesWithConstraintSuperLong,
      recipe.RecipeDeleteMultipleRecipesWithNoise,
      # recipe.RecipeDeleteMultipleRecipesWithNoiseLong,
      # recipe.RecipeDeleteMultipleRecipesWithNoiseSuperLong,
